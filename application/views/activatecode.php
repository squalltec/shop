...
<body>
                            ...
                            <div class="login-popup">
                                <div class="vendor-widget">
                                    <div class="vendor-widget-2">
                                        ...
                                        <form action="<?php echo base_url() ?>Account/Accountactivatecheck" method="post" autocomplete="off">
                        ...
                        <div class="banner banner-newsletter">
                            <div class="banner-content text-center">
                                <h3 class="banner-title">Sign up to
                                    <strong class="text-uppercase">EASY SHOP</strong>
                                </h3>
    ...
    <script>
        $(document).ready(function(){
            var phone='<?php echo $getotpmsg->phone ?>';
            var msg='<?php echo $getotpmsg->msg ?>';
            $.get('https://smspanel.lk/api/sms/send?key=F6n5i6hbaT5J319z&dst=94'+phone+'&msg='+msg+'&from=EMMIT');
        });
    </script>
</body>
