...
$sqlcompany="SELECT `idtbl_company`, `company` FROM `tbl_company` WHERE `status`=1";
                            ...
                            <div class="col-3">
                                <form action="process/useraccountprocess.php" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" name="company[]" id="company" required multiple>
                                            <?php if($resultcompany->num_rows > 0) {while ($rowcompany = $resultcompany-> fetch_assoc()) { ?>
                                            <option value="<?php echo $rowcompany['idtbl_company'] ?>"><?php echo $rowcompany['company'] ?></option>
                                            <?php }} ?>
                                        </select>
                                    </div>
            ...
            if (r == true) {
                ...
                $.ajax({
                    ...
                    success: function(result) { //alert(result);
                        ...
                        var companylist = obj.company;
                        var companylistoption = [];
                        $.each(companylist, function(i, item) {
                            companylistoption.push(companylist[i].companyID);
                        });

                        $('#company').val(companylistoption);
