...
if ($userName && $userPass )
{
    ...
    $query = "SELECT * FROM tbl_user LEFT JOIN tbl_user_has_tbl_company ON tbl_user_has_tbl_company.tbl_user_idtbl_user=tbl_user.idtbl_user WHERE tbl_user.username='$userName' and tbl_user.password='$userPass' AND tbl_user.status=1";// AND password = $userPass";
    ...
    $company = $row['tbl_company_idtbl_company'];
