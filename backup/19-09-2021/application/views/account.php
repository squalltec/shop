...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>About Us - LAOL Mart</title>
				...
				<div class="container clearfix">
					...
					<div class="row clearfix">
						...
						<div class="col-md-9">
							...
							<img src="<?php echo base_url() ?>images/icons/avatar.jpg" class="alignleft img-circle img-thumbnail my-0" alt="Avatar" style="max-width: 84px;">
												...
												<div class="row gutter-40 posts-md mt-4">
													...
													<div class="entry col-12">
														<div class="grid-inner row align-items-center g-0">
															<div class="col-md-4">
																<a class="entry-image" href="<?php echo base_url() ?>images/blog/full/17.jpg" data-lightbox="image"><img src="<?php echo base_url() ?>images/blog/small/17.jpg" alt="Standard Post with Image"></a>
															</div>
																	...
																	<div class="fslider" data-arrows="false" data-lightbox="gallery">
																		<div class="flexslider">
																			<div class="slider-wrap">
																				<div class="slide"><a href="<?php echo base_url() ?>images/blog/full/10.jpg" data-lightbox="gallery-item"><img src="<?php echo base_url() ?>images/blog/small/10.jpg" alt="Standard Post with Gallery"></a></div>
																				<div class="slide"><a href="<?php echo base_url() ?>images/blog/full/20.jpg" data-lightbox="gallery-item"><img src="<?php echo base_url() ?>images/blog/small/20.jpg" alt="Standard Post with Gallery"></a></div>
																				<div class="slide"><a href="<?php echo base_url() ?>images/blog/full/21.jpg" data-lightbox="gallery-item"><img src="<?php echo base_url() ?>images/blog/small/21.jpg" alt="Standard Post with Gallery"></a></div>
																			</div>
																		</div>
																	</div>
																</div>
											...
											<div class="tab-content clearfix" id="tab-connections">
												...
												<div class="row topmargin-sm">
													<div class="col-lg-3 col-md-6 bottommargin">
														...
														<div class="team">
															<div class="team-image">
																<img src="<?php echo base_url() ?>images/team/3.jpg" alt="John Doe">
															</div>
															<div class="team-desc">
													...
													<div class="col-lg-3 col-md-6 bottommargin">
														...
														<div class="team">
															<div class="team-image">
																<img src="<?php echo base_url() ?>images/team/2.jpg" alt="Josh Clark">
															</div>
															<div class="team-desc">
													...
													<div class="col-lg-3 col-md-6 bottommargin">
														...
														<div class="team">
															<div class="team-image">
																<img src="<?php echo base_url() ?>images/team/8.jpg" alt="Mary Jane">
															</div>
															<div class="team-desc">
													...
													<div class="col-lg-3 col-md-6">
														...
														<div class="team">
															<div class="team-image">
																<img src="<?php echo base_url() ?>images/team/4.jpg" alt="Nix Maxwell">
															</div>
															<div class="team-desc">
