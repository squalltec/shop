...
$columns = array(
	...
	array( 'db' => '`u`.`shipcost`', 'dt' => 'shipcost', 'field' => 'shipcost' ),
	array( 'db' => '`u`.`total`', 'dt' => 'total', 'field' => 'total' ),
	array( 'db' => '`u`.`trackingnum`', 'dt' => 'trackingnum', 'field' => 'trackingnum' ),
	...
	array( 'db' => '`u`.`dropdiscountstatus`', 'dt' => 'dropdiscountstatus', 'field' => 'dropdiscountstatus' ),
	...
	array( 'db' => '`ue`.`otherdeliverystatus`', 'dt' => 'otherdeliverystatus', 'field' => 'otherdeliverystatus' )
);
...
$joinQuery = "FROM `tbl_order` AS `u` JOIN `tbl_customer` AS `ud` ON (`ud`.`idtbl_customer` = `u`.`tbl_customer_idtbl_customer`) JOIN `tbl_order_delivery` AS `ue` ON (`ue`.`tbl_order_idtbl_order` = `u`.`idtbl_order`)";
