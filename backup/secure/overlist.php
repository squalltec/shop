                ...
                <div class="container-fluid">
                    <div class="page-header-content py-3">
                        <h1 class="page-header-title">
                            ...
                            <span>Below 1000 customers</span>
                        </h1>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-3">
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                <input type="text" class="form-control dpd1a rounded-0" id="fromdate" name="fromdate" value="<?php echo date('d-m-Y') ?>" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text rounded-0" id="inputGroup-sizing-sm"><i data-feather="calendar"></i></span>
                                                </div>
                                                <input type="text" class="form-control dpd1a rounded-0 border-left-0" id="todate" name="todate" value="<?php echo date('d-m-Y') ?>" required>
                                            </div>
                                        </div>
        ...
        $('#formSearchBtn').click(function(){
            if (!$("#searchFrom")[0].checkValidity()) {
                ...
                $.ajax({
                    ...
                    url: 'getprocess/getoverlist.php',
